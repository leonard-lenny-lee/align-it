...
void printHeader() {
    std::cerr << "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
                 "++++++++++++++"
              << std::endl;
    std::cerr << "  Align-it v" << ALIGNIT_VERSION << "." << ALIGNIT_RELEASE
              << "." << ALIGNIT_SUBRELEASE << " | ";
    ...
    std::cerr
        << "  Align-it is free software: you can redistribute it and/or modify"
        << std::endl;
    std::cerr << "  it under the terms of the GNU Lesser General Public "
    ...
    std::cerr << std::endl;
    std::cerr << "  Align-it is distributed in the hope that it will be useful,"
              << std::endl;
    std::cerr
        << "  but WITHOUT ANY WARRANTY; without even the implied warranty of"
        << std::endl;
    ...
    std::cerr << std::endl;
#ifndef USE_RDKIT
    std::cerr << "  Align-it is linked against OpenBabel version 3."
              << std::endl;
    std::cerr
        << "  OpenBabel is free software; you can redistribute it and/or modify"
        << std::endl;
...
#else
    std::cerr
        << "  Align-it is linked against the RDKit (https://www.rdkit.org)."
        << std::endl;
#endif
    std::cerr << "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
                 "++++++++++++++"
